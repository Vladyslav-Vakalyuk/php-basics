    ...
    <form enctype="multipart/form-data" method="post" action="/">
        ...
        <?php if (! empty($textFromDb)) : ?>
            ...
            <?php foreach ($textFromDb as $key => $value) : ?>
                    <option value="<?php echo $value->hash ?>"><?php echo $value->text ?></option>
            <?php endforeach; ?>
            </select>
        <?php endif; ?>
        <br>
...
<?php $statisticData = TextAnalizer::get(); ?>
    Count Statistic = <?php echo count($statisticData) ?>
    <br>
...
<?php echo 'numberOfCharacter = ' . $numberOfCharacter / count($statisticData) . '<br>' ?>
<?php echo 'countWords = ' . $countWords / count($statisticData) . '<br>' ?>
<?php echo 'countSentences = ' . $countSentences / count($statisticData) . '<br>' ?>